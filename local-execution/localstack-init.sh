...
QUEUES=(
  ...
  "PAYMENT_SERVICE_PAYMENT_REVERT_QUEUE"
...
FILTERS["PAYMENT_SERVICE_PAYMENT_REVERT_QUEUE"]='{"status":["OUT_OF_STOCK","ORDER_NOT_DELIVERED"]}'
...
subscribe_queue "PAYMENT_SERVICE_PAYMENT_REVERT_QUEUE" '{"status":["OUT_OF_STOCK","ORDER_NOT_DELIVERED"]}'
